...
| 2 | Mon, Jan 12 |  Cross-validation   | [[Lec03.pdf](/lectures/lec03.pdf)] | ISL 5.1 <br /> ESL 7.10 |
...
| | Wed, Jan 14 |  Model selection under linear models <br/> Shringkage regression |  [[Lec03.pdf](/lectures/lec03.pdf)][[Lec04.pdf](/lectures/lec04.pdf)]  | ISL 5.1, 6.1, 6.2, 6.4 <br /> ESL 7.10  |
| 3 | Mon, Jan 19 |  Shringkage regression | [[Lec04.pdf](/lectures/lec04.pdf)]  | ISL 6.1, 6.2, 6.4 <br /> ESL 7.10  |
...
| | Wed, Jan 21 | Gradient descent  |  [[Lec08-GD.pdf](/lectures/lec-GD.pdf)] | ISL 4.3, 4.4 <br /> ESL 4.3, 4.4 <br/> PRML 4.1, 4.3 <br />  ConvOpt 2.1-2.3, 3.1, 3.2, 4.1, 4.2 <!--[[Multivariate calculus](/tutorials/review_multi_calculus.pdf)]--> |  |
| 4 | Mon, Jan 26 | Move beyond linearity |  [[Lec05.pdf](/lectures/lec05.pdf)] | ISL 7.1-7.4, 7.6, 7.7  |
...
| | Wed, Feb 4  |  Logistic regression   | [[Lec07.pdf](/lectures/lec-LR-binary.pdf)] [[Lec08-GD.pdf](/lectures/lec-GD.pdf)] | ISL 4.3, 4.4 <br /> ESL 4.3, 4.4 <br/> PRML 4.1, 4.3 <br />  ConvOpt 2.1-2.3, 3.1, 3.2, 4.1, 4.2 <!--[[Multivariate calculus](/tutorials/review_multi_calculus.pdf)]--> |  
...
| | | Tutorial 5 (Review on MLE and GD) | [[Notes](/tutorials/tut06_note.pdf)] | |
| | Wed, Feb 11 |  **Midterm** | | |
...
| | Wed, Feb 25 |   Discriminant analysis <br/> support vector machine |    [[Lec09-DA.pdf](/lectures/lec-DA.pdf)] [[Lec10-SVM.pdf](/lectures/lec-svm.pdf)] |    ISL 4.3-4.4 <br/> ESL 4.3-4.4  <br > [[Dual formulation and kernel trick](/tutorials/reading-svm.pdf)] |
...
| 9 | Mon, Mar 9 |  Bootstrap  |[[Lec12-ET.pdf](/lectures/lec-ET.pdf)] |  ISL 5.2, 5.3.4, 8.2 <br /> ESL 7.11, 8.7, 10.1, 15 <br /> [[Gradient boosting machine](/tutorials/gradient_boosting_machine.pdf)], <br> [[R code on tree-based algorithms](/tutorials/tut-DT-ET.Rmd)] | 
